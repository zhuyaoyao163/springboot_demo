...
<div class = "col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <form role = "form" id="pageForm" method="post" action="${basePath}/carCondition/test" >
        ...
        <div class = "form-group">
            ...
            <select id = "resDepartmentId" class = "form-control"  onchange="initPage();">
        ...
        <div class = "form-group">
            ...
            <select id = "resUserId" class = "form-control">
        ...
        <div class = "form-group">
            ...
            <select id = "resDepartmentLeaderId" class = "form-control">
        ...
        <div class = "form-group">
            ...
            <input type = "button" id = "idCard" onclick="chooseImage();"></input>
        </div>
        <div class="form-group">
